        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-4rem)]">
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300 px-4 py-2 rounded-full text-sm font-medium">
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto lg:mx-0">
                Upload a bill, let AI do the math, and split costs fairly among friends. 
            ...
            <div className="grid sm:grid-cols-3 gap-6 max-w-2xl mx-auto lg:mx-0">
              <div className="flex flex-col items-center lg:items-start gap-2">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white">Fair Splits</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  AI calculates exact amounts including tax and tip
                </p>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Get your split breakdown in seconds
                </p>
              </div>
              <div className="flex flex-col items-center lg:items-start gap-2">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white">Group Ready</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Split between 2-5 people or customize
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 flex items-center justify-center">
            <Card className="w-full max-w-md p-8 shadow-2xl border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl">
              <div className="space-y-6">
                <div className="text-center space-y-2">
                  <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 mb-4">
                ...
                <Button
                  ...
                  disabled={isLoading}
                  size="lg"
                  className="w-full h-12 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm"
                >
                  {isLoading ? (
                ...
                <p className="text-xs text-center text-gray-500 dark:text-gray-400">
                  By continuing, you agree to PayUp's Terms of Service and Privacy Policy
                </p>
              </div>
            </Card>
          </div>
